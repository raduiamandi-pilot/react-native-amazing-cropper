...
import { Animated, PanResponderInstance, PanResponderGestureState, ImageCropData } from 'react-native';
...
declare class CropperPage extends Component<CropperPageProps, State> {
    ...
    rotate90: () => void;
    onRotate: () => void;
    cropImage: (uri: string, cropData: ImageCropData, garbageUris: string[]) => Promise<void>;
